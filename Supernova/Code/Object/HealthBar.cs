...
namespace Supernova.Code.Object {
    public static class HealthBar {
        ...
        private static Vector2 _position = new Vector2(30, 75);
        ...
        public static void Render(SpriteBatch _spriteBatch) {
            ...
            _spriteBatch.Draw(_texture, destinationRectangle: new Rectangle((int)(Camera.GetWidthScalar() * (_position.X - _dimensions.X / 2)), (int)(Camera.GetHeightScalar() * (_position.Y - _dimensions.Y / 2)), (int)(Camera.GetWidthScalar() * _dimensions.X), (int)(Camera.GetHeightScalar() * (_dimensions.Y / 100 * Player.Health))), Color.White);
